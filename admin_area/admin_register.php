...
<div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Registration  admin Form</h5>
...
$select_query="select * from admin_table where username='$username' or user_email='$email'";
...
$insert_query="insert into admin_table (username,user_email,user_password,user_ip,address)
